...
export default class AddRace extends React.Component {
    ...
    handleSubmit = (e) => {
        ...
        RacesService.postRace(JSON.stringify(race))
            .then(() => this.props.history.push('/my-races'))
    ...
    render() {
        ...
        return (
            <form className='edit-race' onSubmit={this.handleSubmit}>
                ...
                <button className="submit" type="submit">Add Race</button>
                <button className="submit" type="button" onClick={() => this.props.history.goBack()}>Back</button>
